...
<h2>Les ventilateurs</h2>
			...
			<tbody><tr><td class="catalogue" width="185"><strong>Marque</strong></td>
 	  		...
 	  		<td class="catalogue" width="146"><strong>Prix</strong></td>
				...
				<td width="426" class="catalogue">Ventilateur AMD Soc A/462 Ultra silencieux 19dba/ 12VDC Fan XP3200 WhisperRock V </td>
				<td width="146" class="catalogue">19 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue"></td>
				<td width="426" class="catalogue">Ventilateur INTEL Socket 478 OEM</td>
				<td width="146" class="catalogue">15 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Connectland</td>
				<td width="426" class="catalogue">Ventilateur AMD Socket A / 462</td>
				<td width="146" class="catalogue">15 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Connectland</td>
				<td width="426" class="catalogue">Ventilateur INTEL Socket 775</td>
				<td width="146" class="catalogue">16 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Speeze</td>
				<td width="426" class="catalogue">Ventilateur INTEL Soc 775  silencieux 26 dba/12VDC Fan</td>
				<td width="146" class="catalogue">15 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Spire</td>
				<td width="426" class="catalogue">Ventilateur AMD Socket 754,940,939,AM2 avec base cuivre </td>
				<td width="146" class="catalogue">19 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Spire</td>
				<td width="426" class="catalogue">Ventilateur INTEL Soc 775 Ultra silencieux 23 dba/12VDC Fan Base Cuivre CoreDuo-</td>
				<td width="146" class="catalogue">17 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Spire</td>
				<td width="426" class="catalogue">Ventilateur INTEL Socket 478 Base cuivre</td>
				<td width="146" class="catalogue">15 €</td>
				</tr>
			
				<tr>
				<td width="185" class="catalogue">Spire</td>
				<td width="426" class="catalogue">Ventilateur INTEL Socket 478 Ultra silencieux 19 dba / 12VDC FAN P4~3.7 GHz / </td>
				<td width="146" class="catalogue">17 €</td>
				</tr>
